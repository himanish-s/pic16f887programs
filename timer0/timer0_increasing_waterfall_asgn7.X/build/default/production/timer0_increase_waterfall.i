...
# 2 "<built-in>" 2
# 1 "timer0_increase_waterfall.c" 2
...
# 8 "timer0_increase_waterfall.c" 2
# 1 "./config.h" 1
# 85 "./config.h"
...
# 9 "timer0_increase_waterfall.c" 2
# 20 "timer0_increase_waterfall.c"
void main(void) {
                ...
                if (PORTC > 0b00000000) {
                    ...
                    switch (s) {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
# 119 "timer0_increase_waterfall.c"
                            PORTC = 0b11111111;
                            s = 1;
                            break;
                        default:
