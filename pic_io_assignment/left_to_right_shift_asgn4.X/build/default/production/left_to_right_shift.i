...
# 2 "<built-in>" 2
# 1 "left_to_right_shift.c" 2
# 14 "left_to_right_shift.c"
...
void main(void) {
    ...
    while(1){
# 51 "left_to_right_shift.c"
       if (PORTC == 0b00000000){

           PORTC = 0b10000000;
# 62 "left_to_right_shift.c"
