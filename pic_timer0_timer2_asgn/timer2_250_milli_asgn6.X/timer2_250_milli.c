/*
 * this program will toggle a pin/LED
 *  pin is RB0 which is pin33
 * at 250ms using TIMER2
 *
...
void main()
{
    ...
    while(TRUE) {
        ...
        if (TMR2IF == 1) {
            ...
            if (count == 250) {
                /* this is 250 milli second block
